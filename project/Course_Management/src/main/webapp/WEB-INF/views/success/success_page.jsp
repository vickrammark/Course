...
<body>
	...
	<div id="page-content-wrapper">
		...
		<!-- Page content-->
		<div class="container-fluid" id="pagecontent" style="text-align: center">
			<div class="col-sm-6 col-sm-offset-3 m-auto">
				<br> <br>
				<h2 >Success</h2>
				<img  alt="no pciture" src="/images/${course.getId()}/${course.getImage()}" style="width:250px;height:250px;border-radius:200px">
				<h3>Hey!! ${user_name}</h3>
				<p style="font-size: 20px;"> You have been successfully enrolled in the ${course.getName()} course. Happy learning</p>
				<a href="/course_display" class="btn btn-success">Go Back</a> <br>
			</div>
		</div>
	</div>
	<!-- Bootstrap core JS-->
