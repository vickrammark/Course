	...
	<div id="page-content-wrapper">
		...
		<div class="container-fluid m-auto" id="pagecontent" style="text-align: center">
			<div class="col-sm-6 col-sm-offset-3 m-auto">
				<br> <br>
				<h2 >Success</h2>
				<img  alt="no picture" src="/images/${course.getId()}/${course.getImage()}" style="width: 250px;height:250px">
				<h3>Hey!!</h3>
				<p style="font-size: 20px;">${course.getName()} course have been added successfully!!</p>
