	...
	<div id="page-content-wrapper">
		...
		<div class="container-fluid m-auto" id="pagecontent" style="text-align: center">
			...
			<div class="container-fluid m-3 p-2" style="height: 300px">
				<img alt="No Picture" src="/images/${course.getCoursePath()}"
					width="250px" height="250px">
			</div>
			<div class="container-fluid m-3 col-lg-6 col-md-12 col-xs-12">
				<div class="form-control p-5 m-auto">
					<form:form action="/updateCourse" modelAttribute="course"
						...
						<div class="form-group m-2">
							Course logo <input class="form-control" type="file"
								name="image_path" placeholder="update picture"
								required="required" />
						</div>
						<div class="form-group m-2">
