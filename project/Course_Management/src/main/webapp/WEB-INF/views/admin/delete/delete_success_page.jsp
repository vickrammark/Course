			...
			<div class="container-fluid">
				<div class="container" style="text-align: center;">
					<div class="col-sm-6 col-sm-offset-3 m-auto">
						<br> <br>
						<h2>Success</h2>
						<img src="/images/${course.getId()}/${course.getImage()}"
							alt="no picture" style="width: 250px; height: 250px;border-radius:250px">
						<h3>Hey!!</h3>
						<p style="font-size: 20px;">The course
							${course.getName()} has been successfully deleted!!</p>
