	...
	<div id="page-content-wrapper">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ms-auto mt-2 mt-lg-0">
						...
						<sec:authorize access="hasRole('admin')">
							<li class="nav-item"><a class="nav-link" href="/addCourse">Admin
									room</a></li>
						</sec:authorize>
						<sec:authorize access="!isAuthenticated()">
		...
		<div class="container-fluid" id="pagecontent" style="text-align: center;">
			<div class="col-sm-6 col-sm-offset-3 m-auto">
				<br>
				<h1 style="text-align: center;">Hey We think you have not given proper information</h1>
				<hr>
				<a href="/home" class="btn btn-success">Go Back</a> <br>
			</div>
		</div>
	</div>
	<!-- Bootstrap core JS-->
